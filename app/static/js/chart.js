    ...
    draw: function (level, id, data) {
        ...
        function buildPolygons(data) {
            vis.vertices
                ...
                .attr("stroke", function (d, i) { return config.colors; })
                .attr("fill", function (d, i) { return config.colors; })
        ...
        function buildLegend(data) {
            ...
            vis.legend.selectAll(".legend-tiles")
                ...
                .attr("fill", function (d, g) { return config.colors; });
